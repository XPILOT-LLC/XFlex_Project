          ...
          {plans.map((plan, index) => (
            <motion.article
              ...
              whileHover={{
                ...
                boxShadow:
                  "inset 0 1px 0 rgba(255,255,255,0.06), 0 0 18px rgba(219,168,51,0.16), 0 24px 58px rgba(0,0,0,0.42)",
                transition: { duration: 0.22, ease: "easeOut" },
              }}
              className={`group/tax-card relative flex flex-col rounded-[12px] border border-[#3e424a] bg-[linear-gradient(180deg,rgba(34,34,34,0.95)_0%,rgba(29,29,29,0.96)_100%)] px-8 py-8 shadow-[inset_0_1px_0_rgba(255,255,255,0.03),0_18px_40px_rgba(0,0,0,0.12)] transition-colors duration-300 [transform-style:preserve-3d] ${
            ...
            >
              ...
              <div
                className="relative mt-4 text-[#d7aa48]"
                style={{
                  fontFamily: "var(--font-poppins), Poppins, sans-serif",
                  fontSize: "15px",
                  lineHeight: "1.3",
              ...
              <div
                className="relative mt-7 text-white/72"
                style={{
                  fontFamily: "var(--font-poppins), Poppins, sans-serif",
                  fontSize: "10px",
                  lineHeight: "1.4",
