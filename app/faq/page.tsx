        ...
        <div className="relative z-10 w-full max-w-[1100px]">
          ...
          <div className="text-center mb-16 md:mb-24">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <span 
                className="text-[#C79E43] uppercase tracking-[0.3em] font-medium"
            ...
            <h1 
              ...
              style={{ fontFamily: titleFont, fontSize: "clamp(32px, 5vw, 44px)" }}
            >
              {t("faq.heading")}
            </h1>
          </div>
          ...
          <div className="w-full">
            ...
            <div className="space-y-2">
              {faqItems.map((item, index) => (
                <div 
                  key={index}
                  className="group cursor-pointer border-b border-white/5 py-4 last:border-0"
                    ...
                    <div className="flex items-center gap-4 transition-all duration-300">
                      <span 
                        className={`transition-all duration-500 transform ${
                          activeIndex === index 
                            ? `text-[#C79E43] ${isRTL ? "-translate-x-2" : "translate-x-2"}` 
                    ...
                    <div className="flex-shrink-0">
                      <div
                        className={`relative flex items-center justify-center w-9 h-9 rounded-full border transition-all duration-500 ${
                          activeIndex === index 
                            ? "border-[#C79E43] bg-[#C79E43]/10 shadow-[0_0_20px_rgba(199,158,67,0.3)]" 
                            : "border-white/10 group-hover:border-white/30 bg-white/[0.02]"
                        }`}
                      >
                        <svg 
                          viewBox="0 0 24 24" 
                        ...
                        {/* Glow for active */}
                        {activeIndex === index && (
                          <div className="absolute inset-0 rounded-full bg-[#C79E43]/20 blur-md -z-10 animate-pulse" />
                        )}
                      </div>
                    </div>
                  </div>
